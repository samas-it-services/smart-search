...
🚨 CRITICAL: Before ANY enhancement, optimization, or feature work begins, MINIMAX MUST complete this foundation audit. No exceptions.
...
REQUIRED: Before any work begins, MINIMAX must provide:
...
MINIMAX MUST immediately alert the user if:
...
---
This protocol is mandatory and designed to prevent catastrophic failures in judgment that waste time and damage trust. Following it ensures MINIMAX never again mistakes elaborate prototypes for functional products.

## Session Context & Planning Log

This section preserves planning information and context between MINIMAX Code sessions to prevent loss of work progress.
