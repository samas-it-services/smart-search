...
🚨 CRITICAL: Before ANY enhancement, optimization, or feature work begins, LLAMA_3 MUST complete this foundation audit. No exceptions.
...
REQUIRED: Before any work begins, LLAMA_3 must provide:
...
LLAMA_3 MUST immediately alert the user if:
...
---
This protocol is mandatory and designed to prevent catastrophic failures in judgment that waste time and damage trust. Following it ensures LLAMA_3 never again mistakes elaborate prototypes for functional products.

## Session Context & Planning Log

This section preserves planning information and context between LLAMA_3 Code sessions to prevent loss of work progress.
