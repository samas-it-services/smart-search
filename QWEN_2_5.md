...
🚨 CRITICAL: Before ANY enhancement, optimization, or feature work begins, QWEN_2_5 MUST complete this foundation audit. No exceptions.
...
REQUIRED: Before any work begins, QWEN_2_5 must provide:
...
QWEN_2_5 MUST immediately alert the user if:
...
---
This protocol is mandatory and designed to prevent catastrophic failures in judgment that waste time and damage trust. Following it ensures QWEN_2_5 never again mistakes elaborate prototypes for functional products.

## Session Context & Planning Log

This section preserves planning information and context between QWEN_2_5 Code sessions to prevent loss of work progress.
